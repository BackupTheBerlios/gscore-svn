...
#define PLUGIN_NAME "NIFF"
#define PLUGIN_VERSION "1"
#define PLUGIN_SUMMARY "NIFF"
#define PLUGIN_DESCRIPTION "Import/Export NIFF Music"
#define PLUGIN_AUTHOR "Sebastien Tricaud <toady@gscore.org>"
#define PLUGIN_HOMEPAGE GSCORE_HOMEPAGE


/* Extensions for the filter */
const gchar *extensions[] = {"nif", NULL};


/* Filter related functions */
gboolean niff_filter_export (Score_t *score,
                              const gchar *filename,
                              void *user_data);
gboolean niff_filter_import (Score_t **score,
                              const gchar *filename,
                              void *user_data);
...
gscore_plugin_init(void)
{
	...
	plugin->filter->import     = niff_filter_import;
	plugin->filter->export     = niff_filter_export;
