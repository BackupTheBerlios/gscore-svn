/*
 * musicxml.c
 * plugin to read/write musicxml music
 *
 * (C) Copyright 2004 Sebastien Tricaud
...
#include "export-musicxml.h"

#define API_VERSION 1
#define PLUGIN_TYPE GSCORE_PLUGIN_FILTER

#define PLUGIN_NAME "MusicXML"
#define PLUGIN_VERSION "1"
#define PLUGIN_SUMMARY "MusicXML"
#define PLUGIN_DESCRIPTION "Import/Export MusicXML Files"
#define PLUGIN_AUTHOR "Toady <toady@gscore.org>"
#define PLUGIN_HOMEPAGE GSCORE_HOMEPAGE


/* Extensions for the filter */
const gchar *extensions[] = {"mxl", NULL};


/* Filter related functions */
gboolean musicxml_filter_export (Score_t *score,
				 const gchar *filename,
				 void *user_data);
gboolean musicxml_filter_import (Score_t **score,
				 const gchar *filename,
				 void *user_data);
...
gscore_plugin_init(void)
{
	...
	plugin->filter->import     = musicxml_filter_import;
	plugin->filter->export     = musicxml_filter_export;
				...
				void *user_data)
{
	...
	printf("Exporting MusicXML score into the filename: %s\n", filename);
