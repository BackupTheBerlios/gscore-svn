...
/* RD 05 Oct 04 An auxiliary (simple) hash function */
/*
  Well, I discovered that writing a "simple" hash function is not a "simple" task!
  To avoid shifting out the effect of the first characters, the highest byte is xored
  again.
  I took the idea from:
     http://www.brpreiss.com/books/opus4/html/page218.html#tblhashingwords
